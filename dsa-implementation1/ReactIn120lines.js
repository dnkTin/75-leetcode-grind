// Refer: https://medium.com/@deathmood/how-to-write-your-own-virtual-dom-ee74acc13060
// Write a simple virtual DOM to understand how React works
//
...
function updateElement(parent, newNode, oldNode, index = 0) {
  if (!oldNode) {
    ...
    parent.removeChilde(parent.childNodes[index]);
...
(() => {
  ...
  class Component {
    ...
    setState(next) {
      const compat = (a) =>
        typeof this.state == "object" && typeof a == "object";
  ...
  if (typeof module == "undefined")
    window.Gooact = { createElement, render, Component };
})();
